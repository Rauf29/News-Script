...
function displayInlineErrors(errors, formId) {
    var form = formId ? $(formId) : $(document);
      ...
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-danger ul').html('');
            ...
            displayInlineErrors(data.errors, '#geniusformdata');
  ...
  $('.gocover').show();
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-success').hide();
          $('.alert-danger').hide();
            displayInlineErrors(data.errors, '#geniusformdataedit');
    ...
    fd.append('result_description[]', result_description[i]);
      ...
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-success').hide();
          $('.alert-danger').hide();
            var quizForm = $(this).closest('form').attr('id') ? '#' + $(this).closest('form').attr('id') : null;
            if (quizForm) displayInlineErrors(data.errors, quizForm);
    ...
    fd.append('item_description[]', item_description[i]);
      ...
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-success').hide();
          $('.alert-danger').hide();
            var sortForm = $(this).closest('form').attr('id') ? '#' + $(this).closest('form').attr('id') : null;
            if (sortForm) displayInlineErrors(data.errors, sortForm);
            $("#modal1 .modal-content .modal-body .alert-danger").focus();
            $('button.addProductSubmit-btn').prop('disabled',false);
            $('#geniusformdata input , #geniusformdata select , #geniusformdata textarea').eq(1).focus();
          }
    ...
    fd.append('result_description[]', result_description[i]);
      ...
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-success').hide();
          $('.alert-danger').hide();
            var pForm = $(this).closest('form').attr('id') ? '#' + $(this).closest('form').attr('id') : null;
            if (pForm) displayInlineErrors(data.errors, pForm);
  ...
  fd.append('description',description);
      ...
      $.ajax({
       ...
       success:function(data)
       {
          ...
          $('.alert-success').hide();
          $('.alert-danger').hide();
            displayInlineErrors(data.errors, '#geniusformdata2');
            $("#modal1 .modal-content .modal-body .alert-danger").focus();
            $('button.addProductSubmit-btn').prop('disabled',false);
            $('#geniusformdata input , #geniusformdata select , #geniusformdata textarea').eq(1).focus();
          }
...
// ADD / EDIT article ENDS
  ...
  $('#confirm-delete .btn-ok').on('click', function(e) {
    ...
    $.ajax({
      type:"GET",
      url: href + separator + '_token=' + getToken(),
      success:function(data)
      {
        console.log(data);
...
$('button.addProductSubmit-btn').prop('disabled',true);
    $.ajax({
     ...
     success:function(data)
     {
        ...
        if ((data.errors)) {
          $('.alert-danger').hide();
          displayInlineErrors(data.errors, '#geniusform');
