                        ...
                        <div class="product-description">
                            <div class="body-area">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                         <select name="language_id" id="article_language_id" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                             <input type="text" class="input-field" id="slug" name="slug" required=""
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="text" class="input-field" name="images_caption"
                                        placeholder="{{ __('Images Caption') }}" id="images_caption" autocomplete="off" value="{{ $data->images_caption }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                             <textarea class="input-field textarea" name="short_description" required="" placeholder="{{__('Short Details')}}">{{ $data->short_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 description">
                                             <textarea class="nic-edit" name="description" required="" placeholder="{{__('Description')}}" id="description">{{ $data->description}}</textarea>
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="product-description">
                                <div class="body-area">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                             <select name="category_id" id="article_parent_id" required="">
                                             </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row datepick" style="display:none;">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input id="from" class="input-field" type="text" name="schedule_post_date" autocomplete="off" placeholder="{{__('Start Date')}}"  value="{{ $data->schedule_post_date}}">
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <form id="post-approve-form" method="POST" style="display:inline">
                    @csrf
                    <button type="submit" class="btn btn-danger btn-ok">{{ __('Approve') }}</button>
                </form>
            </div>
...
<script>
    $('#post-approve').on('show.bs.modal', function(e) {
        var href = $(e.relatedTarget).data('href');
        if (href) {
            $('#post-approve-form').attr('action', href.split('?')[0]);
        }
    });
</script>
