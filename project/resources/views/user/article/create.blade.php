                            ...
                            <div class="product-description">
                                <div class="body-area">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="left-area">
                                                <h4 class="heading">Images Caption</h4>
                                                <p class="sub-heading">{{ __('(In Any Language)') }}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <input type="text" class="input-field" name="images_caption"
                                                placeholder="{{ __('Images Cpation') }}" id="images_caption" autocomplete="off">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                             <textarea class="input-field textarea" name="short_description" required="" placeholder="{{__('Short Details')}}"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 description">
                                                 <textarea class="nic-edit" name="description" required="" placeholder="{{__('Description')}}" id="description"></textarea>
                                            </div>
                                        </div>
                                        <br>
                                </div>
                                            ...
                                            <div class="row datepick" style="display:none;">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input id="from" class="input-field" type="text" name="schedule_post_date" autocomplete="off" placeholder="{{__('Start Date')}}"  value="">
                                                    </div>
                                                </div>
                                            </div>
