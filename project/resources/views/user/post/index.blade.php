        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <form method="POST" action="" id="bulk-delete-form" style="display:inline">
                    @csrf
                    <button type="submit" class="btn btn-danger bulk-delete">{{ __('Delete') }}</button>
                </form>
            </div>
...
<div class="modal fade-scale" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-default" data-dismiss="modal">{{ __('Cancel') }}</button>
                <form id="confirm-delete-form" method="POST" style="display:inline">
                    @csrf
...
<script>
    $('#confirm-delete').on('show.bs.modal', function(e) {
        ...
        if (href) {
            $('#confirm-delete-form').attr('action', href.split('?')[0]);
        }
    });
</script>
