...
<div class="content-area">
    ...
    <form id="sortformdata" action="{{ route('user.shortlist.store')}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
            ...
            <div class="col-lg-8">
                ...
                <div class="row mb-4">
                    <div class="col-lg-12 text-center">
                        <a href="javascript:;" id="quiz-result" class="btn btn-info"> <i class="fa fa-plus"></i>{{__('Add More')}}</a>
                    </div>
                </div>
            </div>
