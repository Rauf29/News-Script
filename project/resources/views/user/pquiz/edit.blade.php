...
<div class="content-area">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('user.post.index') }}">{{ __('Personality Quiz') }}</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <form id="personalityformdata" action="{{route('user.pquiz.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
