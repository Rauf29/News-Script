            ...
            <div class="product-description">
                ...
                <form id="geniusformdata" action="{{route('social.link.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <input type="text" class="input-field" name="link" placeholder="{{ __('Social Link') }}"  value="">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 d-flex">
                            <i class="" id="icn"></i>
                            <input type="text" id="icons" class="input-field" name="icon" placeholder="{{ __('Social Icon') }}"  value="">
                        </div>
