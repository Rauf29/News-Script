                      ...
                      <form id="geniusform" action="{{route('admin.admin_language.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="language" placeholder="{{ __('Language') }}"  value="{{$data->language}}">
                          </div>
                        </div>
                            ...
                            <div class="featured-keyword-area">
                              ...
                              @foreach($lang as $key => $val)
                                ...
                                <div class="lang-area">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <textarea name="keys[]" class="input-field" placeholder="{{ __('Enter Language Key') }}" >{{ $key }}</textarea>
                                    </div>

                                    <div class="col-lg-6">
                                      <textarea  name="values[]" class="input-field" placeholder="{{ __('Enter Language Value') }}" >{{ $val }}</textarea>
                                    </div>
                                  </div>
                                </div>
