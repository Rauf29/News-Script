                            ...
                            <div class="featured-keyword-area">
                              ...
                              <div class="lang-tag-top-filds" id="lang-section">
                                ...
                                <div class="lang-area">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <textarea name="keys[]" class="input-field" placeholder="{{__('Enter Language Key')}}" >{{__('New Conversation(s).')}}</textarea>
                                    </div>

                                    <div class="col-lg-6">
                                      <textarea  name="values[]" class="input-field" placeholder="{{__('Enter Language Value')}}" >{{__('New Conversation(s).')}}</textarea>
                                    </div>
                                  </div>
                                </div>
