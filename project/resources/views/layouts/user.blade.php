												...
												<ul>
													...
													<li>
														<form method="POST" action="{{ route('user.logout') }}" style="display:inline">
															@csrf
															<button type="submit" style="background:none;border:none;padding:0;color:inherit;font:inherit;cursor:pointer"><i class="fas fa-power-off"></i> {{ __('Logout') }}</button>
														</form>
													</li>
												</ul>
											</div>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
                            ...
                            <li>
                                <form method="POST" action="{{ route('user.cache.clear') }}" style="display:inline">
                                    @csrf
                                    <button type="submit" class="wave-effect" style="background:none;border:none;padding:0;color:inherit;font:inherit;cursor:pointer;width:100%;display:flex;align-items:center"><i class="fa fa-database" style="margin-right:8px"></i>{{ __('Clear Cache') }}</button>
                                </form>
                            </li>
						</ul>
