                ...
                <div class="organize-by">
                    <div class="organizer-profile">
                        ...
                        <div class="right">
                            ...
                            <form method="POST" action="{{ route('front.followerCreate',$admin->id) }}" style="display:inline">
                                @csrf
                                <button type="submit" class="btn btn-outline-success btn-sm mr-1">{{__('Follow')}}</button>
                            </form>
