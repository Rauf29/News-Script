...
<meta property="og:title" content="{{$searchKey}}" />
        ...
        <div class="d-flex pb-3 mb-3 border-bottom">
            <div class="flex-shrink-0">
                <div id="img" class="position-relative clearfix">
                    <span class="imgWrep">
                        <img width="500" height="280" src="{{ $post->image_big ? asset('assets/images/post/'.$post->image_big) : $post->rss_image }}" class="attachment-custom-size size-custom-size wp-post-image" alt="" decoding="async" loading="lazy" />                    </span>
                </div>
            </div>
...
@endforeach
                               @else
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="text-danger text-danger text-center">কোন তথ্য পাওয়া যায়নি</p>
                                        </div>
                                    </div>
                                </div>
                        @endif 
