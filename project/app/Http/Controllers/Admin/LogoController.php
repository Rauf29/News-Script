...
class LogoController extends Controller
{
    ...
    public function store(Request $request){
        $rules = [
            ...
            'header_logo'  => 'image|mimes:jpeg,png,jpg,gif,svg,webp,heic|max:2048',
            'footer_logo'  => 'image|mimes:jpeg,png,jpg,gif,svg,webp,heic|max:2048'
        ];
        ...
        if($request->hasFile('header_logo')){
            ...
            $header_name = time().Str::random(8).'.'.$header_logo->getClientOriginalExtension();
        ...
        if($request->hasFile('footer_logo')){
            ...
            $footer_name = time().Str::random(8).'.'.$footer_logo->getClientOriginalExtension();
    ...
    public function update(Request $request,$id){
        ...
        if($request->hasFile('header_logo')){
            $header_logo = $request->file('header_logo');
            $name = time().Str::random(8).'.'.$header_logo->getClientOriginalExtension();
