    ...
    public function datatables(){
        ...
        return Datatables::of($datas)
                            ->addColumn('action',function(AdminLanguage $data){
                                ...
                                $default = $data->is_default == 1 ? '<a><i class="fa fa-check"></i> Default</a>' : '<form method="POST" action="'.route('admin.admin_language.status',$data->id).'" style="display:inline">'.csrf_field().'<button type="submit" class="btn btn-link" style="padding:0">Set Default</button></form>';
