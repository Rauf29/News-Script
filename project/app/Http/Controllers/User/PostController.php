    ...
    public function datatables(Request $request){
        ...
        return Datatables::of($datas)
                            ->addColumn('action', function(Post $data) {
                                ...
                                return '<div class="godropdown"><button class="go-dropdown-toggle"> Actions<i class="fas fa-chevron-down"></i></button><div class="action-list">'.$details.''.$edit.'<a href="javascript:;" data-href="'.route('user.post.delete',$data->id).'" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i> Delete</a></div></div>';
                            })
